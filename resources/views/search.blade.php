            ...
            <div class="col-12 col-md-5 search-panel">
                <div class="row tab">
                    <div class="col-4 tab__item">
                        <button class="tab__button tab__button--left tab__button--active" onclick="location.href='/search#form'">Исполнители</button>
                    </div>
                    <div class="col-8 tab__item">
                        <button class="tab__button tab__button--right" onclick="location.href='/best_price#form'">Поиск лучшего предложения</button>
                    </div>
                </div>
                    ...
                    @foreach($masters as $master)
                        <div class="row profile">
                            ...
                            <div class="row flex-row-reverse">
                                ...
                                <div class="col-12 col-sm-3 col-md-3 col-lg-3">
                                    <button class="button button--blue button--price" onclick="location.href = '/profile/{{$master->id}}'">Цены и отзывы</button>
                                </div>
                            </div>
